...
@Component(resource = "/components/borrowing-component.fxml")
public class BorrowingComponent extends BaseComponent {
    ...
    public void moreSettings(){
        router.accept(BorrowingSettingComponent.class,new BorrowingSettingComponent.Props(((Props) props).email,((Props) props).id, ((Props) props).date, ((Props) props).returnedDate,  ((Props) props).status, ((Props) props).copies));
    }
}
